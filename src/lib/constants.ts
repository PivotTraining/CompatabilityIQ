...
export const MODULE_CONFIG = [
  ...
  { module: 4, title: 'How You Connect',           subtitle: 'Giving & receiving connection styles',          quotients: ['receiving_language', 'giving_language'] as const,                      questionCount: 16, unlockCount: 10, estimatedMinutes: 3, paid: false },
