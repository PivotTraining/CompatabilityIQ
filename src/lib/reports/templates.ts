...
export const DIMENSION_NARRATIVES: Record<string, ScoreRangeNarratives> = {
  ...
  how_you_loves: {
    high: [
      ...
      "Your connection style compatibility is exceptional. You instinctively show love in the way your partner most values receiving it. This kind of alignment means your effort actually registers -- no wasted gestures, no unmet needs.",
      "Most couples have to learn each other's connection styles through trial and error. You two are starting with a natural advantage: what feels like love to you is what the other person is already offering.",
      "Your connection styles create a virtuous cycle -- the more naturally you express affection, the more your partner feels loved, the more they reciprocate in your language. This dynamic builds momentum instead of frustration."
    ],
    medium: [
      "Your connection style compatibility has real strengths, with some areas where you'll need to stretch. The good news: your flexibility scores suggest you're both willing to adapt how you show love, which compensates for any give-receive mismatch.",
      "There's a partial connection style match here that works in your favor, and both of you show the kind of flexibility that bridges the gap. You may need to explicitly tell each other what makes you feel most loved -- but you'll both actually listen.",
      "Your connection styles don't perfectly align, but your willingness to adapt is high. The couples who struggle with connection styles aren't the ones who differ -- they're the ones who refuse to learn. You two don't have that problem.",
    ],
    low: [
      "Your connection styles are notably different -- what feels like love to you may not register at all for your partner, and vice versa. The path forward is explicit communication: telling each other exactly what you need instead of hoping they'll intuit it.",
      ...
      "Connection style mismatch creates a frustrating dynamic where both people feel like they're giving and neither feels like they're receiving. Your gap here is real but solvable -- the key is translating intention into the format your partner actually absorbs.",
    ]
  }
}
...
export const USER_PROFILE_TEMPLATES: Record<string, Record<string, string[]>> = {
  ...
  how_you_loves: {
    verbal_appreciation: [
      "{name}'s primary connection style is Verbal Appreciation. They feel most loved when their partner is specific, verbal, and expressive about what they appreciate and admire.",
    ],
    thoughtful_actions: [
      "{name}'s primary connection style is Thoughtful Actions. Actions speak louder than words for them -- when a partner handles responsibilities or takes something off their plate, that's love.",
    ],
    meaningful_gestures: [
      "{name}'s primary connection style is Meaningful Gestures. It's not about the price tag -- it's about a partner who noticed, remembered, and translated that into something tangible.",
    ],
    focused_presence: [
      "{name}'s primary connection style is Focused Presence. Undivided attention, phones away, fully present -- that's what makes them feel most connected.",
    ],
    physical_closeness: [
      "{name}'s primary connection style is Physical Closeness. Holding hands, a hand on the small of the back, pulling close without being asked -- that's how they feel loved.",
    ],
  },
}
...
export const STRENGTH_NARRATIVES: Record<string, string[]> = {
  ...
  how_you_loves: [
    ...
    "Your connection style compatibility means you'll spend less time guessing what the other person needs and more time actually meeting those needs. It's the difference between effort that registers and effort that gets lost in translation.",
    "Connection style alignment this strong is rare. Most couples have to deliberately learn each other's language -- you two are already speaking it naturally.",
  ],
}
...
export const FRICTION_NARRATIVES: Record<string, string[]> = {
  ...
  how_you_loves: [
    "Your connection styles are mismatched, which means your natural expressions of love may not register with your partner. The fix is surprisingly simple: ask each other \"what makes you feel most loved?\" and then actually do that thing, even when it doesn't come naturally.",
    "Connection style differences create a frustrating dynamic where both people feel like they're giving but neither feels like they're receiving. Your task: learn each other's language and practice it deliberately. It feels awkward at first and becomes natural with repetition.",
    "Your connection style gap is your most actionable growth area. Unlike values or attachment, this one has a clear, concrete solution: learn what your partner needs, tell them what you need, and practice showing up in each other's language consistently.",
  ],
}
...
export const CONVERSATION_STARTERS: Record<string, string[]> = {
  ...
  how_you_loves: [
    "Ask {partnerName}: \"What's the most loved you've ever felt in a relationship? What was the person doing?\" Their answer is their connection style in action.",
    "You scored {scoreLabel} on connection style compatibility. Ask: \"If I could only show you I love you in one way for the rest of our lives, what would you want that way to be?\"",
    "Try: \"Do you feel more loved when someone tells you how they feel about you, or when they show it through actions?\" This binary question cuts to the core of their receiving connection style.",
